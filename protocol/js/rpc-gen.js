...
export type TeamOperation = {|manageMembers: Boolean, manageSubteams: Boolean, createChannel: Boolean, deleteChannel: Boolean, renameChannel: Boolean, editChannelDescription: Boolean, setTeamShowcase: Boolean, setMemberShowcase: Boolean, changeOpenTeam: Boolean, leaveTeam: Boolean, changeTarsDisabled: Boolean|}
...
export type TeamsGetTarsDisabledRpcParam = {|name: String, incomingCallMap?: IncomingCallMapType, waitingHandler?: WaitingHandlerType|}
...
export type TeamsSetTarsDisabledRpcParam = {|name: String, disabled: Boolean, incomingCallMap?: IncomingCallMapType, waitingHandler?: WaitingHandlerType|}
